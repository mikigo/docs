import{_ as s,c as i,o as a,U as n}from"./chunks/framework.SXCkb8Xf.js";const E=JSON.parse('{"title":"Nginx入门使用","description":"","frontmatter":{"counter":true},"headers":[],"relativePath":"Linux/工具使用/Nginx入门使用.md","filePath":"Linux/工具使用/Nginx入门使用.md","lastUpdated":1705282658000}'),p={name:"Linux/工具使用/Nginx入门使用.md"},l=n(`<h1 id="nginx入门使用" tabindex="-1">Nginx入门使用 <a class="header-anchor" href="#nginx入门使用" aria-label="Permalink to &quot;Nginx入门使用&quot;">​</a></h1><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># ==================================</span></span>
